...
bool ChannelListPageSchRecording::init(ElementDisplayListSystem *edls,ssize_t index,bool is_channellist)
{

	if (CScheduleManager::getInstance()->getScheduleRec(schedules))
	{
...
TableViewCell* ChannelListPageSchRecording::tableCellAtIndex(TableView *table, ssize_t idx)
{
    ...
    if (!cell) {
		...
		imageView = ui::ImageView::create("epgturning/epg_rec.png");
...
ssize_t ChannelListPageSchRecording::numberOfCellsInTableView(TableView *table)
{
