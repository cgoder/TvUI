...
public:
	...
	bool isIdxVisible(cocos2d::Node* node,int idx);
	cocos2d::Vec2 scrollToIndex(int idx);
	cocos2d::Vec2 scrollStep(int step, cocos2d::ui::Widget::FocusDirection direction);
protected:
	...
	long __indexFromOffset(cocos2d::Vec2 offset, int row);
	long _indexFromOffset(cocos2d::Vec2 offset, int row);
