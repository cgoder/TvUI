#ifndef  _TV_GUIDE_COUNTRY_H_
#define  _TV_GUIDE_COUNTRY_H_
#include "cocos2d.h"
...
public:
	...
	void setCountryVec(std::vector<std::string> vec) { m_countryVec = vec; };
		
protected:
	std::vector<std::string> m_menuNameVec;
	int m_menuIdx;
	std::vector<std::string> m_countryVec;
};
#endif //_TV_GUIDE_COUNTRY_H_
