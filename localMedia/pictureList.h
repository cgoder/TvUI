#ifndef  _PICTURE_LIST_H_
#define  _PICTURE_LIST_H_
#include "cocos2d.h"
...
public:
	...
	void setPicVec(std::vector<std::string> vec) { m_pictureListVec = vec; };
protected:
	std::vector<std::string> m_menuNameVec;
	int m_menuIdx;
	std::vector<std::string> m_pictureListVec;
};
#endif
